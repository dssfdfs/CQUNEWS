          ...
          <div className={`fixed top-0 right-0 h-full w-1/2 bg-white z-50 shadow-2xl transition-transform duration-300 ease-out ${isDrawerOpen ? 'translate-x-0' : 'translate-x-full'}`}>
            <div className="flex flex-col h-full">
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-6">
                ...
                <div className="flex items-center gap-2">
                  <span className={`px-3 py-1 rounded-full text-sm font-medium ${getCategoryStyle(selectedItem!.category).bg} ${getCategoryStyle(selectedItem!.category).text}`}>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="p-4 bg-blue-50 rounded-lg border border-blue-100">
                      <div className="text-xs font-medium text-blue-600 mb-1">客观纪实标题</div>
                      <div className="text-gray-800">{selectedItem!.titles.objective || '未生成'}</div>
                    </div>
                    <div className="p-4 bg-green-50 rounded-lg border border-green-100">
                      <div className="text-xs font-medium text-green-600 mb-1">数据亮点标题</div>
                      <div className="text-gray-800">{selectedItem!.titles.dataHighlight || '未生成'}</div>
                    </div>
                    <div className="p-4 bg-purple-50 rounded-lg border border-purple-100">
                      <div className="text-xs font-medium text-purple-600 mb-1">轻量化标题</div>
                      <div className="text-gray-800">{selectedItem!.titles.lightweight || '未生成'}</div>
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div className="p-4 bg-green-50 rounded-lg border border-green-200 text-center">
                        <div className="text-2xl font-bold text-green-600">{selectedItem!.quality.coverageRate || 0}%</div>
                        <div className="text-sm text-gray-600 mt-1">覆盖率</div>
                      </div>
                      <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200 text-center">
                        <div className="text-2xl font-bold text-yellow-600">{selectedItem!.quality.titleDeviation || 0}%</div>
                        <div className="text-sm text-gray-600 mt-1">标题偏离度</div>
                      </div>
                      <div className="p-4 bg-red-50 rounded-lg border border-red-200 text-center">
                        <div className="text-2xl font-bold text-red-600">{selectedItem!.quality.hallucinationCount || 0}</div>
                        <div className="text-sm text-gray-600 mt-1">幻觉检测数</div>
                      </div>
                    </div>
                  </div>
                )}
              ...
              <div className="border-t border-gray-200 px-6 py-4 flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 bg-blue-500 text-white px-6 py-3 rounded-lg hover:bg-blue-600 transition-colors font-medium"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 bg-red-100 text-red-700 px-6 py-3 rounded-lg hover:bg-red-200 transition-colors font-medium"
                >
