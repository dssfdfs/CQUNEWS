      ...
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-100">{t('ai_news_assistant')}</h1>
            <p className="text-gray-500 dark:text-gray-400 mt-2">智能新闻摘要与标题生成平台</p>
          </div>

          <div className="flex items-center justify-center mb-6 p-1 bg-gray-100 dark:bg-gray-700 rounded-lg">
            <button
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder={isAdminLogin ? t('enter_admin_username') : t('enter_username')}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder={isAdminLogin ? t('enter_admin_password') : t('enter_password')}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{t('captcha')}</label>
              <div className="flex items-center gap-3">
                <div className="relative flex-1">
                  <input
                    ...
                    maxLength={4}
                    className="w-full pl-4 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition-all bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500"
                  />
                </div>
                <div className="flex items-center gap-2">
                  <div className="px-4 py-3 bg-gray-100 dark:bg-gray-700 rounded-lg font-mono text-xl font-bold text-gray-700 dark:text-gray-200 tracking-wider select-none">
                    {captcha.split('').map((char, i) => (
                      <span key={i} style={{ transform: `rotate(${(Math.random() - 0.5) * 20}deg)` }}>
                        {char}
                      </span>
                    ))}
                  </div>
            ...
            >
              {isLoading ? (
                ...
                isAdminLogin ? t('admin_login') : t('login')
              )}
            </button>
          </form>
          ...
          {!isAdminLogin && (
            <div className="mt-6 text-center">
              <p className="text-gray-500 dark:text-gray-400 text-sm">
                {t('no_account')} {' '}
                <Link to="/register" className="text-primary-600 font-medium hover:text-primary-700 dark:hover:text-primary-400">
                  {t('register_now')}
                </Link>
              </p>
            </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 dark:border-gray-700">
            <div className="flex items-center justify-center gap-4">
              <span className="text-sm text-gray-400">{t('or_login_with')}</span>
            </div>
