...
def store_verification_code(key: str, code: str, expires_minutes: int = 5) -> None:
...
def verify_verification_code(key: str, code: str) -> bool:
...
def delete_verification_code(key: str) -> None:
