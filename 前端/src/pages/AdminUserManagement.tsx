  ...
  const formatDate = (dateStr: string | null) => {
    ...
    try {
      ...
      if (hour >= 24) {
        ...
        return `${nextDay.getUTCFullYear()}/${nextDay.getUTCMonth() + 1}/${nextDay.getUTCDate()} ${String(hour).padStart(2, '0')}:${String(minute).padStart(2, '0')}`;
      }
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <button
                            ...
                            className="flex items-center gap-1 text-indigo-600 hover:text-indigo-700 text-sm font-medium mr-4"
                          >
                            查看详情
