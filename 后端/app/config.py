...
class Settings(BaseSettings):
    ...
    DOUBAO_MODEL_NAME: str = "Doubao-seed2.0-lite"
    DOUBAO_API_URL: str = "https://ark.cn-beijing.volces.com/api/v3"

    DOUBAO_VIDEO_API_KEY: str = ""
    DOUBAO_VIDEO_ENDPOINT_ID: str = ""
    DOUBAO_VIDEO_MODEL_NAME: str = "doubao-seed-2-1-pro-260628"
    DOUBAO_VIDEO_API_URL: str = "https://ark.cn-beijing.volces.com/api/v3"

    ERNIE_API_KEY: str = ""
    ERNIE_SECRET_KEY: str = ""
    ERNIE_ENDPOINT_ID: str = ""
    ERNIE_API_URL: str = "https://aip.baidubce.com/rpc/2.0/ai_custom/v1/wenxinworkshop/chat/completions"
    ERNIE_MODEL_NAME: str = "ernie-4.0"
