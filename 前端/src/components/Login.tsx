      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-800">AI 新闻助手</h1>
            <p className="text-gray-500 mt-2">智能新闻摘要与标题生成平台</p>
          </div>

          <div className="flex items-center justify-center mb-6 p-1 bg-gray-100 rounded-lg">
            <button
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder={isAdminLogin ? '请输入管理员用户名' : '请输入用户名'}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder={isAdminLogin ? '请输入管理员密码' : '请输入密码'}
              ...
              <div className="flex items-center gap-3">
                <div className="relative flex-1">
                  <input
                    ...
                    placeholder="请输入验证码"
                    maxLength={4}
                    className="w-full pl-4 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition-all"
                  />
                </div>
                <div className="flex items-center gap-2">
                  <div className="px-4 py-3 bg-gray-100 rounded-lg font-mono text-xl font-bold text-gray-700 tracking-wider select-none">
          ...
          <div className="mt-8 pt-6 border-t border-gray-100">
            <div className="flex items-center justify-center gap-4">
              <span className="text-sm text-gray-400">或使用以下方式登录</span>
            </div>
