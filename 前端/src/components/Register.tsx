      ...
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-2">加入 AI 新闻助手，体验智能摘要服务</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-start gap-2">
              <input
                type="checkbox"
                id="terms"
                className="mt-1 w-4 h-4 text-primary-600 rounded border-gray-300 dark:border-gray-600 focus:ring-primary-500 bg-white dark:bg-gray-700"
              />
              <label htmlFor="terms" className="text-sm text-gray-600 dark:text-gray-300">
                我同意{' '}
                <a href="#" className="text-primary-600 hover:text-primary-700 dark:hover:text-primary-400">服务条款</a>{' '}
                和{' '}
                <a href="#" className="text-primary-600 hover:text-primary-700 dark:hover:text-primary-400">隐私政策</a>
              </label>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-500 dark:text-gray-400 text-sm">
              已有账号？{' '}
              <Link to="/login" className="text-primary-600 font-medium hover:text-primary-700 dark:hover:text-primary-400">
                立即登录
              </Link>
            </p>
          </div>
